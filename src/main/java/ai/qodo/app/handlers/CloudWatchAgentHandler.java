...
import static ai.qodo.app.controllers.CloudWatchLogWebhookController.MSG_AWS_CLOUD;
...
public class CloudWatchAgentHandler extends BaseHandler {
    ...
    public Map<String, Object> handle(Map<String, Object> map) {
        logger.info("CloudWatchAgentHandler processing message: {}", map);
        logger.info("Message will be routed to next handler type: {}", type());
